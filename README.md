This repository contains the different java script files that have been developed in Google Earth Engine to complete the fourth module of MB5370, Data analysis at the global scale.

This module is divided into four workshops aiming at developing knowledge and skills in data analysis using Google Earth engine (GEE).

The first workshop aimed at getting used to GEE, and the javascript interface and language it uses.
...
The last two files contains work aiming at developing skills by using actual thematic related to marine biology analysis. In this case the presence of night lights across the world and spatial analysis of research stations surroundings.
